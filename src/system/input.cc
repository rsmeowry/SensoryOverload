...
void InputSystem::RegisterCommand(const std::string &name,
                                  CommandCallback callback) {
  commands_[name] = callback;
}

void InputSystem::RegisterAlias(const std::string &alias,
...
bool InputSystem::ExecuteCommand(const std::string &input, GlobalState &state,
